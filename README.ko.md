...
`grok`은 그중에서 다시 볼 만한 설명을 재사용할 수 있는 노트로 남겨 줍니다. 
어시스턴트에게 개념을 물어보면 grok이 직접 검색한 출처를 바탕으로 짧게 설명하고, 
간직하고 싶은 내용만 개인 학습 폴더에 일반 Markdown 노트로 저장합니다.
...
저장된 노트는 그냥 Markdown 파일입니다. 
읽고, 검색하고, 직접 고칠 수 있으며, 다시 필요해질 때까지 그냥 두어도 됩니다.
